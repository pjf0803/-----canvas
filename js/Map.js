	...
	Map.prototype.createSpritesByCode = function(){
		for (var i = 0; i < 7; i++) {
			for (var j = 0; j < 7; j++) {
				...
				// console.log(this.code[i][j].length);
				// console.log(this.imageNameArr.length);
			}
		}
	}
